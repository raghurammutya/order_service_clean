"""
Order Service Configuration - Config-Service Compliant
...
Bootstrap Pattern:
- Docker-compose provides: ENVIRONMENT, CONFIG_SERVICE_URL, INTERNAL_API_KEY
- Config-service provides: All database URLs, secrets, service-specific config
- Service code fetches everything (except bootstrap triad) from config-service APIs
"""
import os
import logging
import sys
...
# =============================================================================
# LEGACY SERVICE DISCOVERY FUNCTIONS (FOR COMPATIBILITY)
# =============================================================================

def get_service_url(service_name: str, **kwargs) -> str:
    """Legacy compatibility function - now uses config service"""
    return _build_service_url(service_name)
...
# =============================================================================
# CONFIG-SERVICE COMPLIANT SETTINGS CLASS  
# =============================================================================
...
class Settings(BaseSettings):
    ...
    def database_url(self) -> str:
        return _get_config_value("DATABASE_URL", required=True, is_secret=True, 
                                default_value="postgresql://test:test@localhost/test_order_service")
    ...
    def redis_url(self) -> str:
        return _get_config_value("REDIS_URL", required=True, is_secret=True, 
    ...
    def INTERNAL_SERVICE_SECRET(self) -> str:
        return _get_config_value("INTERNAL_SERVICE_SECRET", required=True, is_secret=True, 
                                default_value="test-internal-secret")
    ...
    def validate_configuration(self):
        ...
        # Validate bootstrap triad is present
...
# Create config-service compliant settings instance
settings = Settings()
